                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Red</td>
                                <td>
                                    <span class="d-inline-block rounded-circle" style="width:20px; height:20px; background-color: red;"></span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>Blue</td>
                                <td>
                                    <span class="d-inline-block rounded-circle" style="width:20px; height:20px; background-color: blue;"></span>
                                </td>
                                <td class="text-center">
                                    <button class="btn btn-sm btn-outline-primary me-1">
                                        <i class="bi bi-pencil"></i> Edit
