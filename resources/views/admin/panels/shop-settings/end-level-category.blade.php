        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="table-responsive">
                ...
                <thead class="table-light">
                    <tr>
                    <th scope="col" class="sortable">ID <i class="bi bi-arrow-down-up ms-1 text-muted"></i></th>
                    <th scope="col" class="sortable">End Level Category <i class="bi bi-arrow-down-up ms-1 text-muted"></i></th>
                    <th scope="col" class="sortable">Mid Level Category <i class="bi bi-arrow-down-up ms-1 text-muted"></i></th>
                    <th scope="col" class="sortable">Top Level Category <i class="bi bi-arrow-down-up ms-1 text-muted"></i></th>
