    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <thead class="table-light">
                ...
                <th scope="col">
                    Top Level Category
                    <button wire:click="sortBy('top_category_name')" class="btn btn-sm btn-link p-0 ms-1 text-secondary">
                    <i class="bi bi-arrow-down-up"></i>
                    </button>
                </th>
        ...
        <div class="d-flex justify-content-between align-items-center my-3">
            <div>
                Showing {{ $mid_level_categories->firstItem() }} to {{ $mid_level_categories->lastItem() }} of {{ $mid_level_categories->total() }} results
            </div>
            <div>
                {{ $mid_level_categories->links('pagination::livewire-bootstrap') }}
            </div>
        </div>
    </div>
</div>