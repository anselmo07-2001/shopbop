<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <tbody>
                @foreach ($top_level_categories as $t_category)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <x-delete-modal 
                                        ...
                                        action="{{ route('admin.shopSetting.topLevelCategory.destroy', $t_category->id)}}"
                            />  
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="d-flex justify-content-between align-items-center my-3">
            <div>
                Showing {{ $top_level_categories->firstItem() }} to {{ $top_level_categories->lastItem() }} of {{ $top_level_categories->total() }} results
            </div>
            <div>
                {{ $top_level_categories->links('pagination::livewire-bootstrap') }}
            </div>
         </div>
