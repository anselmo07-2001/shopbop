    ...
    <div class="container">
        ...
        <div class="logo">
            <a href="{{ route('home') }}" class="d-inline-block">
                <img src="{{ asset('storage/branding/' . $global_page_settings->logo ) }}" alt="logo image" class="img-fluid" style="max-width: 150px;">           
            </a>
        </div>
        ...
        <div class="d-flex align-items-center flex-wrap gap-3">
            ...
            <ul class="list-inline mb-0 me-3">
               ...
               @endauth
                ...
                @auth("customer")
                    <li class="list-inline-item">
                        <a href="{{ route('dashboard.index') }}" class="text-black text-decoration-none">
